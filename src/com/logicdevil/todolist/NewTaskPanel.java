...
public class NewTaskPanel extends JPanel {
    ...
    private JPanel createPanel() {
        ...
        JComboBox<Integer> yearComboBox = new JComboBox<Integer>(years);
        c.fill = GridBagConstraints.HORIZONTAL;
        c.insets = new Insets(0,0,0, 0);
        c.gridx++;
        ...
        NewTaskLabelTemplate titleLabel = new NewTaskLabelTemplate("Enter a title (up to 80 characters):", JLabel.LEFT);
        c.insets = new Insets(0,0,0, 0);
        c.gridwidth = 7;
        c.gridy++;
        c.gridx = 0;
